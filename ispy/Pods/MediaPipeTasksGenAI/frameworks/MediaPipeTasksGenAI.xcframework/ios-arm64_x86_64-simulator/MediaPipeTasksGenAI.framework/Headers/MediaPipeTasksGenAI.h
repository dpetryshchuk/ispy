...
#endif
// Rewritten: @import CoreGraphics;
// From module CoreGraphics
...
/// the main thread.
SWIFT_CLASS_NAMED("LlmInference") SWIFT_DEPRECATED_MSG("Migrate to LiteRT LM instead. For more details, refer to LiteRT LM on GitHub: https://github.com/google-ai-edge/LiteRT-LM")
...
/// Note: Inherits from <code>NSObject</code> for Objective-C interoperability.
SWIFT_CLASS_NAMED("Session") SWIFT_DEPRECATED_MSG("Migrate to LiteRT LM instead: https://github.com/google-ai-edge/LiteRT-LM")
...
/// conversion process.
typedef SWIFT_ENUM(int32_t, LlmPreferredBackend, open) {
/// Use default backend extracted from the model.
  LlmPreferredBackendDefaultBackend = 0,
/// Use GPU backend.
  LlmPreferredBackendGpu = 1,
/// Use CPU backend.
  LlmPreferredBackendCpu = 2,
};

/// Options for setting up a <code>LlmInference</code>.
/// Note: Inherits from <code>NSObject</code> for Objective C interoperability.
SWIFT_CLASS_NAMED("Options") SWIFT_DEPRECATED_MSG("Migrate to LiteRT LM instead. For more details, refer to LiteRT LM on GitHub: https://github.com/google-ai-edge/LiteRT-LM")
...
@property (nonatomic, copy) NSString * _Nonnull visionEncoderPath;
/// Path to the vision adapter to use for vision modality. Optional.
@property (nonatomic, copy) NSString * _Nonnull visionAdapterPath;
...
/// decoding is supported for any sessions created with this <code>LlmInference</code>. Default value is 40.
